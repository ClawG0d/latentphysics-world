...
insertion, tool use** — via IK-scripted contact (no learned policies), and a
**12-task benchmark suite** auto-verifies behavior with physically checkable
predicates. Every number above sits next to the committed test that enforces it.
...
| [Manipulation: tool use](examples/franka_tool_use.py) | [Rigid: collision tower](examples/collision_tower.py) | [Rigid: contype masks](examples/contype_demo.py) |
| <img src="docs/media/franka_tool_use.webp" width="240"> | <img src="docs/media/collision_tower.webp" width="240"> | <img src="docs/media/contype_masks.webp" width="240"> |
